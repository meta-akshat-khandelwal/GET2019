package com.metacube.EADAssignment8.controller;
...
public class UserController {
	...
	public String update(User user)
	{
		...
		System.out.println("Redirected to All user");
		return "redirect:/user/allUser";
	}
	...
	public ModelAndView searchUserByFirstName(@RequestParam("first_name") String first_name)
	{
		List<User> usersList= userService.getUser("first_name", first_name);
	...
	public ModelAndView searchUserByLastName(@RequestParam("last_name") String last_name)
	{
		List<User> usersList= userService.getUser("last_name", last_name);
		return new ModelAndView("user/allUser","users", usersList) ;
	}
	...
	public ModelAndView searchUserByContact(@RequestParam("contact_number") String contact_number)
	{
		List<User> usersList= userService.getUser("contact_number", contact_number);
		return new ModelAndView("user/allUser","users", usersList) ;
	}
