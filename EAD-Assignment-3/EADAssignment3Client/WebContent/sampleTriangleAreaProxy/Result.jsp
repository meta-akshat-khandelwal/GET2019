...
<jsp:useBean id="sampleTriangleAreaProxyid" scope="session" class="com.metacube.soap.service.TriangleAreaProxy" />
<%
...
case 10:
        gotMethod = true;
        com.metacube.soap.service.TriangleArea getTriangleArea10mtemp = sampleTriangleAreaProxyid.getTriangleArea();
...
case 13:
        ...
        double calculateArea13mtemp = sampleTriangleAreaProxyid.calculateArea(side1_1idTemp,side2_2idTemp,side3_3idTemp);
