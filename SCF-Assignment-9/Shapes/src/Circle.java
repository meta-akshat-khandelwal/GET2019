...
public class Circle implements Shapes {
	...
	{
		boolean flg=false;
		double differnceX=point.getxPoint()-origin.getxPoint();
		double differnceY=point.getyPoint()-origin.getyPoint();
		if((differnceX*differnceX)+(differnceY*differnceY)<= radius*radius)
		{
			flg=true;
		}
